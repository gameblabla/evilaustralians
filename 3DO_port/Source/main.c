...
int main(void)
{
	...
	Load_SFX(0, "DATA/hit.aiff");
	Load_SFX(1, "DATA/hit2.aiff");
	Load_SFX(2, "DATA/shoot.aiff");
	Load_SFX(3, "DATA/victory.aiff");
...
void Draw_Back()
{
	...
	for(i=0;i<40;i++)
	{
		Put_sprite(4, (i*8), 0, 8, 40, i);
		Put_sprite(4, (i*8), 40, 8, 40, i+40);
		Put_sprite(4, (i*8), 80, 8, 40, i+80);
...
void Press_Start_prompt()
{
	...
	if (highscore > 0)
	{
		...
		Print_text(120, 212, itoa(highscore));
	}
