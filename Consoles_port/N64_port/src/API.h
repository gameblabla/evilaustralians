...
extern void Put_image_trans(unsigned short a, short x, short y);
extern void Put_sprite_trans(unsigned short a, short x, short y, unsigned short w, unsigned short h, unsigned char f);
