...
#define	VM_320x240_8BITS	0
#define	VM_320x240_16BITS	1
#define	VM_640x480_8BITS	2
#define	VM_320x180_16BITS	3
#define	VM_640x480_16BITS	4
...
void	FastCopy16(__reg("a0") void *src, __reg("a1") void *dst, __reg("d0") unsigned short size);
void	VFastCopy16(__reg("a0") void *src, __reg("a1") void *dst, __reg("d0") unsigned short size);
